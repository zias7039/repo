    ...
    <div style='display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 12px; margin-bottom: 16px;'>
        ...
        <div class="stat-card">
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:4px;">
                ...
                <div style="font-size:0.75rem; color:var(--color-up); background:rgba(46,189,133,0.1); padding:2px 6px; border-radius:4px;">
                    {withdrawable_pct:.1f}%
                </div>
            </div>
            <div style="font-size:1.4rem; font-weight:700; color:var(--text-primary);">
        ...
        <div class="stat-card">
            ...
            <div style="font-size:1.4rem; font-weight:700; color:var(--text-primary);">
                ...
                <span style="font-size:0.9rem; color:var(--color-accent); margin-left:4px; vertical-align:middle;">
                    {est_leverage:.1f}x
                </span>
            </div>
        ...
        <div class="stat-card" style="border:1px solid {pnl_color}; background: linear-gradient(145deg, var(--bg-card), {pnl_bg});">
            <div style="color:var(--text-secondary); font-size:0.85rem; margin-bottom:4px;">미실현 손익 (Unrealized PNL)</div>
